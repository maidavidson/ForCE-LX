...
%% Input/output datafile names (base directory is the project name directory, in which two folders must exit: ontputData & inputData). Filenames can be user defined.
 ...
 filename.output='./outputData/perranTest_LX';             % Output filename
...
% Cross-shore and Longshore averaging window (days) - Only used if defined
% model.Tn=600;
% model.Ts=10*365;
...
%% Define constants
 ...
 model.axisEqual=1; % Makes map plot axis equal
                                                                     ...
                                                                     % If this field is specified optimisation uses calibration.MCLArray_xy, comment out to use calibration.MCLArray